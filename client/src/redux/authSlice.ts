...
const fetchUser = createAsyncThunk("https://c-teen.vercel.app/api/users/UserProfile", async () => {
  try {
...
const fetchUsers = createAsyncThunk("https://c-teen.vercel.app/api/users/getAllUsers", async () => {
  try {
...
const fetchUpdateUser = createAsyncThunk("https://c-teen.vercel.app/api/users/updateUser", async (data: object | string) => {
  try {
...
const fetchUpdateEventsUser = createAsyncThunk("https://c-teen.vercel.app/api/users/updateEventsUser", async (post:Post) => {
  try {
    const response = await axiosInstance.put(
...
const fetchDeleteUser = createAsyncThunk("https://c-teen.vercel.app/api/users/deleteUser", async (userId:string | number) => {
  try {
    const response = await axiosInstance.put(
...
const fetchDeleteEventUser = createAsyncThunk("https://c-teen.vercel.app/api/users/deleteEventUser", async (post:Post) => {
  try {
    const response = await axiosInstance.put(
